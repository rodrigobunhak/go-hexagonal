...
import (
	...
	"github.com/rodrigobunhak/go-hexagonal/adapters/cli"
	mock_application "github.com/rodrigobunhak/go-hexagonal/application/mocks"
...
func TestRun(t *testing.T) {
	...
	resultExpected := fmt.Sprintf("Product ID %s with the name %s has been created with the price %f and status is %s", productId, productName, productPrice, productStatus)
